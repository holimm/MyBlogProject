...
const AboutMe = () => {
    const content = { 
        ...
        line6: "Cho tới Hè năm nay, 2022. Mình muốn bắt đầu một cái gì đó mới nên mình đã tạo ra website này bằng ReactJS, TailwindCSS và Laravel, với mục đích thử nghiệm là chính.",
